...
class CpuAnzeige2 extends Anzeige implements CpuBeobachter {
  ...
  public void Befehlsmeldung(String string, String string2, String string3, String string4, String string5,
    ...
    this.bild.DatenSetzen(string, string2, string3, string4, string5, string6,
        "Z:" + (bl ? "*" : " ") + " N:" + (bl2 ? "*" : " ") + " V:" + (bl3 ? "*" : " "), string8, string9, string10,
        string7, arrstring, arrstring2, arrstring3, arrstring4, arrstring5, arrstring6,
        this.erweiterungenItem.isSelected(), string11);
    this.bildgross.DatenSetzen(string, string2, string3, string4, string5, string6,
        "Z:" + (bl ? "*" : " ") + " N:" + (bl2 ? "*" : " ") + " V:" + (bl3 ? "*" : " "), string8, string9, string10,
        string7, arrstring, arrstring2, arrstring3, arrstring4, arrstring5, arrstring6,
        this.erweiterungenItem.isSelected(), string11);
  }
