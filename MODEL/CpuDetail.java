    ...
    public void MikroSchritt() {
        switch (this.mikroStatus) {
            ...
            case fetch_opcode: {
                ...
                this.Melden("" + n, "" + (this.pcAlt < 0 ? 65536 + this.pcAlt : this.pcAlt), "", "", "", false, this.pcAlt, -1, this.sp.WertGeben(), "fetch_op");
                break;
            }
            case fetch_adressteil: {
                ...
                if (this.adressmodus == 4 || this.adressmodus == 5) {
                    ...
                    this.adressmodus = 1;
                    this.Melden("" + this.adresse + "(SP)", "" + (this.pcAlt < 0 ? 65536 + this.pcAlt : this.pcAlt), string, "" + this.sp.WertGeben(), "" + this.adresse, false, -1, -1, -1, "fetch_adr");
                    break;
                }
    ...
    private void Excecute1() {
        block0 : switch (this.befehlscode) {
            ...
            case 20: {
                ...
                this.mikroStatus = MikroSchritte.komplett;
                if (this.adressmodus == 1) {
                    this.Melden("" + n, "" + (this.adresse < 0 ? 65536 + this.adresse : this.adresse), "", "", "", true, -1, this.adresse, -1, "exec_1");
                    break;
                }
                this.Melden("", "", "", "", "", true, -1, -1, -1, "exec_1");
                break;
                ...
                if (this.erweitert) {
                    switch (this.befehlscode) {
                        ...
                        case 6: {
                            ...
                            this.Melden("" + (n < 0 ? n + 65536 : n), "" + (this.sp.WertGeben() < 0 ? this.sp.WertGeben() + 65536 : this.sp.WertGeben()), "", "", "", true, this.pc.WertGeben(), -1, -1, "exec_1");
                            break block0;
                        }
                        case 5: {
                            this.mikroStatus = MikroSchritte.execute_2;
